...
namespace Lombiq.Vsix.Orchard.Options
{
    ...
    public class LogWatcherOptionsPage : DialogPage, ILogWatcherSettings
    {
        ...
        [Description("Enable/disable Log Watcher feature. " +
            "With this option turned off the Log Watcher won't check if the log file has any new entry.")]
        ...
        [Description("If your app doesn't the standard Orchard log file naming " +
            ...
            "Note that with a large number of matching files this will be slow so empty the log directory often.")]
